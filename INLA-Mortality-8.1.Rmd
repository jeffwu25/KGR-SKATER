...
Note: 8.1 means 8 clusters, method 1 (default)
...
```{r}
clusterlabels = data.frame(CA_data_cluster$NAME,clus8$groups)
...
CA_cluster = data.frame(CA_sf$NAMELSAD,clus8$groups)

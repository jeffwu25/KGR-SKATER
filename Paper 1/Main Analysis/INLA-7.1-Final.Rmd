...
CA_data_cluster = (CA_sf %>% mutate(clus = clus7$groups))
...
```{r}
clusterlabels = data.frame(CA_data_cluster$NAME,clus7$groups)
...
CA_cluster = data.frame(CA_sf$NAMELSAD,clus7$groups)
...
#Fit kgr_model2
kgr_model2_fit = kgr_model2(dataset = inla_insample_data,rho_EPA_rbf = 2851.121,rho_EPA_periodic = 1742.134, sigma2_EPA = 0.928)
...
```{r}
test1 = ref_model3(dataset = inla_insample_data, cluster = 1, rho_time_rbf = 189.238,
                   rho_time_periodic = 5.326, sigma2_time = 3.737)
test2 = ref_model3(dataset = inla_insample_data, cluster = 2, rho_time_rbf = 10.740,
                   rho_time_periodic = 473.920, sigma2_time = 1.888)
test3 = ref_model3(dataset = inla_insample_data, cluster = 3, rho_time_rbf = 49.688,
                   rho_time_periodic = 85.443, sigma2_time = 3.088)
test4 = ref_model3(dataset = inla_insample_data, cluster = 4, rho_time_rbf = 523.900,
                   rho_time_periodic = 6.745, sigma2_time = 2.922) #why does sigma2 have to be so big here??
test5 = ref_model3(dataset = inla_insample_data, cluster = 5, rho_time_rbf = 13.272,
                   rho_time_periodic = 62.572, sigma2_time = 4.925)
test6 = ref_model3(dataset = inla_insample_data, cluster = 6, rho_time_rbf = 445.155,
                   rho_time_periodic = 14.753, sigma2_time = 0.234) #why does sigma2 have to be so big here??
test7 = ref_model3(dataset = inla_insample_data, cluster = 7, rho_time_rbf = 37.579,
                   rho_time_periodic = 63.145, sigma2_time = 3.129)
...
#Fit kgr_model1
kgr_model1_fit = kgr_model1(dataset = inla_insample_data,rho_time_rbf = 455.749,rho_time_periodic = 293.420,sigma2_time = 4.966)
...
#Fit kgr_model3
kgr_model3_fit = kgr_model3(dataset = inla_insample_data, rho_EPA_rbf = 3352.512, rho_EPA_periodic = 3343.085,
                            rho_time_rbf = 2861.374, rho_time_periodic = 92.313, sigma2 = 4.986)
...
#Fit kgr_model4
kgr_model4_fit = kgr_model4(dataset = inla_insample_data, rho_EPA_rbf = 453.807, rho_EPA_periodic = 243.621,
                            rho_time_rbf = 536.616, rho_time_periodic = 9.626, sigma2_EPA = 4.900, sigma2_time = 4.942)
...
#Fit kgr_model5
kgr_model5_fit = kgr_model5(dataset = inla_insample_data, rho_AR_rbf = 0.009, rho_AR_periodic = 0.004,
                            rho_DL_rbf = 0.008, rho_DL_periodic = 0.013, rho_int_rbf = 0.003,
                            rho_int_periodic = 0.013, sigma2_AR = 3.062, sigma2_DL = 3.511, sigma2_int = 0.060, link=1)
...
```{r,warning=FALSE}
#Run model 
kgr_model2_outfit = kgr_model2(data = inla_outsample_data,rho_EPA_rbf = 2851.121,rho_EPA_periodic = 1742.134, sigma2_EPA = 4.795)
...
```{r}
test1 = ref_model3(dataset = inla_outsample_data, cluster = 1, rho_time_rbf = 189.238,
                   rho_time_periodic = 5.326, sigma2_time = 3.737)
test2 = ref_model3(dataset = inla_outsample_data, cluster = 2, rho_time_rbf = 10.740,
                   rho_time_periodic = 473.920, sigma2_time = 1.888)
test3 = ref_model3(dataset = inla_outsample_data, cluster = 3, rho_time_rbf = 49.688,
                   rho_time_periodic = 85.443, sigma2_time = 3.088)
test4 = ref_model3(dataset = inla_outsample_data, cluster = 4, rho_time_rbf = 523.900,
                   rho_time_periodic = 6.745, sigma2_time = 2.922) #why does sigma2 have to be so big here??
test5 = ref_model3(dataset = inla_outsample_data, cluster = 5, rho_time_rbf = 13.272,
                   rho_time_periodic = 62.572, sigma2_time = 4.925)
test6 = ref_model3(dataset = inla_outsample_data, cluster = 6, rho_time_rbf = 445.155,
                   rho_time_periodic = 14.753, sigma2_time = 0.234) #why does sigma2 have to be so big here??
test7 = ref_model3(dataset = inla_outsample_data, cluster = 7, rho_time_rbf = 37.579,
                   rho_time_periodic = 63.145, sigma2_time = 3.129)
...
```{r}
#Fit kgr_model1
kgr_model1_outfit = kgr_model1(dataset = inla_outsample_data,rho_time_rbf = 455.749,rho_time_periodic = 293.420,sigma2_time = 4.966)
...
```{r,warning=FALSE}
#Fit kgr_model3
kgr_model3_outfit = kgr_model3(dataset = inla_outsample_data, rho_EPA_rbf = 3352.512, rho_EPA_periodic = 3343.085,
                            rho_time_rbf = 2861.374, rho_time_periodic = 92.313, sigma2 = 4.986)
...
```{r,warning=FALSE}
#Fit kgr_model4
kgr_model4_outfit = kgr_model4(dataset = inla_outsample_data, rho_EPA_rbf = 453.807, rho_EPA_periodic = 243.621,
                            rho_time_rbf = 536.616, rho_time_periodic = 9.626, sigma2_EPA = 4.900, sigma2_time = 4.942, link = 1)
...
```{r}
#Fit kgr_model5
kgr_model5_outfit = kgr_model5(dataset = inla_outsample_data, rho_AR_rbf = 0.009, rho_AR_periodic = 0.004,
                            rho_DL_rbf = 0.008, rho_DL_periodic = 0.013, rho_int_rbf = 0.003,
                            rho_int_periodic = 0.013, sigma2_AR = 3.062, sigma2_DL = 3.511, sigma2_int = 0.060, link=1)

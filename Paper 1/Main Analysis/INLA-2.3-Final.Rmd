...
CA_data_cluster = (CA_sf %>% mutate(clus = clus2_minarea$groups))
...
```{r}
clusterlabels = data.frame(CA_data_cluster$NAME,clus2_minarea$groups)
...
This code chunk takes the cluster grouping from SKATER and aggregates the full dataframe from the SPDF (58x10) into a 10x5 matrix (10 time points x 5 clusters) to be fed into the graph estimation package HUGE. The data from each county in a given cluster is aggregated based on a population weighted mean.
...
CA_cluster = data.frame(CA_sf$NAMELSAD,clus2_minarea$groups)
...
$Y_{i,t} \sim Pois(\lambda_{i,t})$ for $i=1,2$ and $t=1,...,54$ where $log(\lambda_{i,t}) = \beta_0 + \beta_1 * I \{t=2,14,...,50 \} + ... + \beta_{11} * I \{t=12,24,...,54 \} + u_i$
...
#Run model 
ref_model1_fit = ref_model1(dataset = inla_insample_data,a_prior = 1,b_prior = 0.50005)
...
$Y_{i,t} \sim Pois(\lambda_{i,t})$ for $i=1,2$ and $t=1,...,54$ where $log(\lambda_{i,t}) = \beta_0 + \beta_1 * I \{t=2,14,...,50 \} + ... + \beta_{11} * I \{t=12,24,...,54 \} + \phi + u_i$
...
#Fit ref_model2
ref_model2_fit = ref_model2(dataset = inla_insample_data,a_prec_prior = 1,b_prec_prior = 0.50005,
                            a_phi_prior = 5,b_phi_prior = 0.50005)
...
#Fit kgr_model2
kgr_model2_fit = kgr_model2(dataset = inla_insample_data, rho_EPA_rbf = 167.334,
                            rho_EPA_periodic = 151.329, sigma2_EPA = 4.844)
...
```{r}
test1 = ref_model3(dataset = inla_insample_data, cluster = 1, rho_time_rbf = 243.521,
                   rho_time_periodic = 5.103, sigma2_time = 3.398)
test2 = ref_model3(dataset = inla_insample_data, cluster = 2, rho_time_rbf = 11.763,
                   rho_time_periodic = 201.882, sigma2_time = 4.020)
...
#Fit kgr_model1
kgr_model1_fit = kgr_model1(dataset = inla_insample_data,rho_time_rbf = 18.351,
                            rho_time_periodic = 164.561,sigma2_time = 3.584)
...
#Fit kgr_model3
kgr_model3_fit = kgr_model3(dataset = inla_insample_data, rho_EPA_rbf = 684.754, rho_EPA_periodic = 517.920,
                            rho_time_rbf = 19.602, rho_time_periodic = 527.720, sigma2 = 4.667, link=1)
...
#Fit kgr_model4
kgr_model4_fit = kgr_model4(dataset = inla_insample_data, rho_EPA_rbf = 129.632, rho_EPA_periodic = 38.633,
                            rho_time_rbf = 24.306, rho_time_periodic = 131.091, sigma2_EPA = 4.695, sigma2_time = 4.149)
...
#Fit kgr_model5
kgr_model5_fit = kgr_model5(dataset = inla_insample_data, rho_AR_rbf = 0.015, rho_AR_periodic = 0.005,
                            rho_DL_rbf = 0.002, rho_DL_periodic = 0.008, rho_int_rbf = 0.004,
                            rho_int_periodic = 0.013, sigma2_AR = 4.152, sigma2_DL = 4.470, sigma2_int = 3.963, link=1)
...
$Y_{i,t} \sim Pois(\lambda_{i,t})$ for $i=1,2$ and $t=1,...,60$ where $log(\lambda_{i,t}) = \beta_0 + \beta_1 * I \{t=2,14,...,50 \} + ... + \beta_{11} * I \{t=12,24,...,60 \} + u_i$
...
```{r}
#Run model 
ref_model1_outfit = ref_model1(inla_outsample_data, a_prior=1, b_prior=0.50005)
...
$Y_{i,t} \sim Pois(\lambda_{i,t})$ for $i=1,2$ and $t=1,...,60$ where $log(\lambda_{i,t}) = \beta_0 + \beta_1 * I \{t=2,14,...,50 \} + ... + \beta_{11} * I \{t=12,24,...,60 \} + \phi + u_i$
...
```{r}
#Run model 
ref_model2_outfit = ref_model2(dataset = inla_outsample_data,a_prec_prior = 1,b_prec_prior = 0.50005,
                            a_phi_prior = 5,b_phi_prior = 0.50005)
...
```{r,warning=FALSE}
#Run model 
kgr_model2_outfit = kgr_model2(data = inla_outsample_data, rho_EPA_rbf = 167.334,
                            rho_EPA_periodic = 151.329, sigma2_EPA = 4.844)
...
```{r}
test1 = ref_model3(dataset = inla_outsample_data, cluster = 1, rho_time_rbf = 243.521,
                   rho_time_periodic = 5.103, sigma2_time = 3.398)
test2 = ref_model3(dataset = inla_outsample_data, cluster = 2, rho_time_rbf = 11.763,
                   rho_time_periodic = 201.882, sigma2_time = 4.020)
...
```{r}
#Fit kgr_model1
kgr_model1_outfit = kgr_model1(dataset = inla_outsample_data,rho_time_rbf = 18.351,
                            rho_time_periodic = 164.561,sigma2_time = 3.584)
...
```{r,warning=FALSE}
#Fit kgr_model3
kgr_model3_outfit = kgr_model3(dataset = inla_outsample_data, rho_EPA_rbf = 684.754, rho_EPA_periodic = 517.920,
                            rho_time_rbf = 19.602, rho_time_periodic = 527.720, sigma2 = 4.667, link=1)
...
```{r,warning=FALSE}
#Fit kgr_model4
kgr_model4_outfit = kgr_model4(dataset = inla_outsample_data, rho_EPA_rbf = 129.632, rho_EPA_periodic = 38.633,
                            rho_time_rbf = 24.306, rho_time_periodic = 131.091, sigma2_EPA = 4.695, sigma2_time = 4.149)
...
```{r}
#Fit kgr_model5
kgr_model5_outfit = kgr_model5(dataset = inla_outsample_data, rho_AR_rbf = 0.015, rho_AR_periodic = 0.005,
                            rho_DL_rbf = 0.002, rho_DL_periodic = 0.008, rho_int_rbf = 0.004,
                            rho_int_periodic = 0.013, sigma2_AR = 4.152, sigma2_DL = 4.470, sigma2_int = 3.963, link=1)

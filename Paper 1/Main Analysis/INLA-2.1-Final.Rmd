...
CA_data_cluster = (CA_sf %>% mutate(clus = clus2$groups))
...
```{r}
clusterlabels = data.frame(CA_data_cluster$NAME,clus2$groups)
...
CA_cluster = data.frame(CA_sf$NAMELSAD,clus2$groups)
...
#Fit kgr_model2
kgr_model2_fit = kgr_model2(dataset = inla_insample_data, rho_EPA_rbf = 190.424,
                            rho_EPA_periodic = 194.036, sigma2_EPA = 4.958)
...
```{r}
test1 = ref_model3(dataset = inla_insample_data, cluster = 1, rho_time_rbf = 485.317,
                   rho_time_periodic = 4.603, sigma2_time = 3.656)
test2 = ref_model3(dataset = inla_insample_data, cluster = 2, rho_time_rbf = 6.636,
                   rho_time_periodic = 323.542, sigma2_time = 0.240)
...
#Fit kgr_model1
kgr_model1_fit = kgr_model1(dataset = inla_insample_data,rho_time_rbf = 9.005,
                            rho_time_periodic = 244.118,sigma2_time = 4.736)
...
#Fit kgr_model3
kgr_model3_fit = kgr_model3(dataset = inla_insample_data, rho_EPA_rbf = 777.369, rho_EPA_periodic = 337.826,
                            rho_time_rbf = 72.238, rho_time_periodic = 156.301, sigma2 = 4.421)
...
#Fit kgr_model4
kgr_model4_fit = kgr_model4(dataset = inla_insample_data, rho_EPA_rbf = 190.238, rho_EPA_periodic = 1.008,
                            rho_time_rbf = 14.208, rho_time_periodic = 82.089, sigma2_EPA = 2.331, sigma2_time = 4.316)
...
#Fit kgr_model5
kgr_model5_fit = kgr_model5(dataset = inla_insample_data, rho_AR_rbf = 0.008, rho_AR_periodic = 0.006,
                            rho_DL_rbf = 0.008, rho_DL_periodic = 0.007, rho_int_rbf = 0.006,
                            rho_int_periodic = 0.006, sigma2_AR = 4.590, sigma2_DL = 4.845, sigma2_int = 4.979, link=1)
...
```{r,warning=FALSE}
#Run model 
kgr_model2_outfit = kgr_model2(data = inla_outsample_data, rho_EPA_rbf = 190.424,
                            rho_EPA_periodic = 194.036, sigma2_EPA = 4.958)
...
```{r}
test1 = ref_model3(dataset = inla_outsample_data, cluster = 1, rho_time_rbf = 485.317,
                   rho_time_periodic = 4.603, sigma2_time = 3.656)
test2 = ref_model3(dataset = inla_outsample_data, cluster = 2, rho_time_rbf = 6.636,
                   rho_time_periodic = 323.542, sigma2_time = 0.240)
...
```{r}
#Fit kgr_model1
kgr_model1_outfit = kgr_model1(dataset = inla_outsample_data,rho_time_rbf = 9.005,
                            rho_time_periodic = 244.118,sigma2_time = 4.736)
...
```{r,warning=FALSE}
#Fit kgr_model3
kgr_model3_outfit = kgr_model3(dataset = inla_outsample_data, rho_EPA_rbf = 777.369, rho_EPA_periodic = 337.826,
                            rho_time_rbf = 72.238, rho_time_periodic = 156.301, sigma2 = 4.421, link=1)
...
```{r,warning=FALSE}
#Fit kgr_model4
kgr_model4_outfit = kgr_model4(dataset = inla_outsample_data, rho_EPA_rbf = 190.238, rho_EPA_periodic = 1.008,
                            rho_time_rbf = 14.208, rho_time_periodic = 82.089, sigma2_EPA = 2.331, sigma2_time = 4.316)
...
```{r}
#Fit kgr_model5
kgr_model5_outfit = kgr_model5(dataset = inla_outsample_data, rho_AR_rbf = 0.008, rho_AR_periodic = 0.006,
                            rho_DL_rbf = 0.008, rho_DL_periodic = 0.007, rho_int_rbf = 0.006,
                            rho_int_periodic = 0.006, sigma2_AR = 4.590, sigma2_DL = 4.845, sigma2_int = 4.979, link=1)
